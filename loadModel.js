...
var homeIndex;
//模型偏移位置
var model_x = -85*(document.documentElement.clientHeight/632);
var model_y = 100*(document.documentElement.clientHeight/632);
//渲染模型的宽高
var modelWidth = 500*(document.documentElement.clientHeight/632);
var modelHight = 450*(document.documentElement.clientHeight/632);
//渲染模型的比例
var scale = 25*(document.documentElement.clientHeight/632);
if(document.documentElement.clientHeight>document.documentElement.clientWidth){
modelWidth = 1000*(document.documentElement.clientWidth/632);
modelHight = 950*(document.documentElement.clientWidth/632);
scale = 40*(document.documentElement.clientWidth/632);
...
function setMouseTrick(model,app,canvas,motions){
    var rect = document.getElementById("l2dc").getBoundingClientRect();
    ...
    document.body.addEventListener("click", function(e){
        ...
        if(motions.length == 0){ return; }
            var rect2 = document.getElementById("l2dc").getBoundingClientRect();
            if(mouse_x>rect2.left&&mouse_x<rect2.left+rect2.width/2){
                if(mouse_y>rect2.top&&mouse_y<rect2.top+rect2.height){
